...
6. Client-side navigation using React Router
7. Book borrowing functionality
...
4. better-auth — Handles user authentication
5. @better-auth/mongo-adapter — Connects Better Auth with MongoDB
6. mongodb — Database connectivity and data management
7. @heroui/react — Provides reusable UI components
8. @heroui/styles — Styling support for HeroUI
9. @gravity-ui/icons — Icon library
10. react-icons — Additional icons for the application
11. react-fast-marquee — Creates the scrolling effect
12. tailwindcss — CSS framework for responsive styling
13. @tailwindcss/postcss — PostCSS integration for Tailwind CSS
14. daisyui — For UI components
